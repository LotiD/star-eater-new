          ...
          <div className="container mx-auto px-4">
            <div className="section-animate opacity-0">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-10 max-w-4xl mx-auto">
                <div className="bg-white p-8 rounded-xl shadow-lg text-center transform hover:scale-110 transition-transform border-4 border-purple-500 neon-effect">
                ...
                <div className="bg-white p-8 rounded-xl shadow-lg text-center transform hover:scale-110 transition-transform border-purple-500 neon-effect">
