    ...
    <div className="min-h-screen">
      ...
      <section className="bg-gradient-to-r from-purple-900 to-indigo-800 text-white py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-5xl font-bold mb-6">STAR EATER</h1>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              <h3 className="text-xl font-semibold mb-4">Persévérance</h3>
              <p className="text-gray-600">Nous ne reculons devant aucun défi pour atteindre l'excellence.</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              <h3 className="text-xl font-semibold mb-4">Créativité</h3>
              <p className="text-gray-600">Nous donnons vie aux idées les plus audacieuses.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-8">Prêt à commencer votre voyage littéraire ?</h2>
          <Link 
            href="/projets" 
